...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="data_kelas.php">Data Kelas</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="mt-3">
            ...
            <hr>
            <div>
                <a href="input_data_kelas.php"><button class="btn btn-primary mt-4"><i class="fa-regular fa-plus"></i> Tambah Data</button></a>
            </div>
            <?php
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="col">
                                <center><?php echo $result['nama_kelas']; ?></center>
                            </th>
                            <th scope="col">
                                <center>
                                    <a href="input_data_kelas.php?edit=<?php echo $result['id_kelas']; ?>" class="btn btn-warning"><i class="fa-regular fa-pencil"></i></a>
                                    <a href="proses_kelas.php?hapus=<?php echo $result['id_kelas']; ?>" class="btn btn-danger" onclick="return confirm ('Anda yakin akan menghapus data?')"><i class="fa-regular fa-trash"></i></a>
                                </center>
                            </th>
                        </tr>
                    <?php
