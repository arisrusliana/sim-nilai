...
<body>
    ...
    <div class="container">
        <div class="mt-3">
            ...
            <hr>
            <div>
                <a href="input_data_jadwal.php"><button class="btn btn-primary mt-4"><i class="fa-regular fa-plus"></i> Tambah Data</button></a>
            </div>
            <?php
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="col">
                                <center><?php echo $result['kode_jadwal']; ?></center>
                            </th>
                            <th scope="col">
                                <center><?php echo $result['kode_kelas']; ?></center>
                            </th>
                            <th scope="col">
                                <center><?php echo $result['kode_pelajaran']; ?></center>
                            </th>
                            <th scope="col">
                            ...
                            <th scope="col">
                                <center>
                                    <a href="input_data_jadwal.php?edit=<?php echo $result['id_jadwal']; ?>" class="btn btn-warning"><i class="fa-regular fa-pencil"></i></a>
                                    <a href="proses_jadwal.php?hapus=<?php echo $result['id_jadwal']; ?>" class="btn btn-danger" onclick="return confirm ('Anda yakin akan menghapus data?')"><i class="fa-regular fa-trash"></i></a>
                                </center>
                            </th>
                        </tr>
                    <?php
